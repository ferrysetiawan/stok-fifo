...
<section class="section">
    <div class="section-header d-flex justify-content-between">
        <h1>Halaman Laporan Stok Masuk</h1>
        <form method="GET" class="d-flex" action="{{ url('/laporan-stok-masuk') }}">
            ...
            <div class="col-lg-12">
                <div class="card shadow">
                    <div class="card-header bg-primary d-flex justify-content-between align-items-center">
                        <h3 class="text-light">
                            Laporan Stok Masuk Bulan {{ DateTime::createFromFormat('!m', $bulan)->format('F') }} {{ $tahun }}
                        </h3>
                    </div>
                    <div class="">
                        <div class="card-body">
