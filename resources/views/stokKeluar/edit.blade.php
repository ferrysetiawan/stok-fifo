        ...
        <div class="row my-5">
            <div class="col-lg-12">
                <div class="card shadow">
                    ...
                    <div class="">
                        <div class="card-body">
                            <form action="{{ route('stok_keluar.update', $stokKeluar->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="field_name">Tanggal Keluar</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="bahan_baku_id" class="form-control select2" id="bahanBaku">
                                        <option value="{{ $stokKeluar->bahanBaku->id }}">{{ $stokKeluar->bahanBaku->bahan_baku }}</option>
                                    </select>
                                </div>
